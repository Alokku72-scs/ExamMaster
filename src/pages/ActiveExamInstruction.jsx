...
function ActiveExamInstruction() {
    ...
    const { exam ,userData} = location.state || {}; // Extract exam data
    // console.log("Instruction page", exam); // Debug log to verify exam data
    const checkboxRef = useRef(null);
    console.log('instruction user',userData);
    const submitHandler = (event) => {
        event.preventDefault();
        if (checkboxRef.current && checkboxRef.current.checked) {
            navigate('/student/active-exam-paper', { state: { exam, userData } }); // Pass exam data
...
export default ActiveExamInstruction;