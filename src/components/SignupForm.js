    ...
    return (
            ...
            <form onSubmit={submitHandler} className='flex flex-col w-full gap-y-2 mt-2'>
                <div className='flex justify-between'>
                    <label>
                        <p className='text-[0.875rem] text-black font-serif mb-1 leading-[1.375rem]'>
                        ...
                        <input
                            ...
                            className='bg-white border-2 rounded-[0.5rem] text-black w-full p-[12px]'
                        />
                    </label>
                    <label>
                        <p className='text-[0.875rem] text-black font-serif mb-1 leading-[1.375rem]'>
                ...
                <label className='relative'>
                    ...
                    <input
                        ...
                        className='bg-white border-2 rounded-[0.5rem] text-black w-full p-[12px]'
                    />
                    <span className='absolute right-3 top-[42px] cursor-pointer' onClick={() => setShowPassword(prev => !prev)}>
                ...
                <label className='relative'>
                    ...
                    <input
                        ...
                        className='bg-white border-2 rounded-[0.5rem] text-black w-full p-[12px]'
                    />
                    <span className='absolute right-3 top-[42px] cursor-pointer' onClick={() => setShowPassword1(prev => !prev)}>
